...
model_urls = {
    'mobilenet_v2': 'https://download.pytorch.org/pretrained/mobilenet_v2-b0353104.pth',
}
...
def _make_divisible(v, divisor, min_value=None):
    ...
    It can be seen here:
    https://github.com/tensorflow/pretrained/blob/master/research/slim/nets/mobilenet/mobilenet_v2.py
    :param v:
    :param divisor:
    :param min_value:
    :return:
...
class MobileNetV2(nn.Module):
    ...
    def forward(self, x):
        x = self.features(x)  # torch.Size([32, 1280, 8, 6])
        # x = x.mean([2, 3])
        # x = self.classifier(x)
